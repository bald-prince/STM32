...
{	
	...
	//初始化PD0,1,4,5,8,9,10,14,15  D2 D3 NOE NWE D13 D14 D15 D0 D1
	...
	//初始化PE7,8,9,10,11,12,13,14,15   D4 D5 D6 D7 D8 D9 D10 D11 D12
...
{ 	  
	...
	GPIO_Initure.Pin=GPIO_PIN_15;          	//PB15,背光控制    LCD_BL
