...
#define TIM_CounterMode_Down               ((uint16_t)0x0010)//向下计数模式
#define TIM_CounterMode_CenterAligned1     ((uint16_t)0x0020)//向上向下双向计数模式1
#define TIM_CounterMode_CenterAligned2     ((uint16_t)0x0040)//向上向下双向计数模式2
#define TIM_CounterMode_CenterAligned3     ((uint16_t)0x0060)//向上向下双向计数模式3
...
#define TIM_IT_CC1                         ((uint16_t)0x0002)//捕获中断
