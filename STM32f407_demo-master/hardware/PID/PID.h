...
*/
void new_PID(PID_Class *mpid,PID_type* Input,PID_type* Output,PID_type* Setpoint,PID_type Kp,PID_type Ki,PID_type Kd,he POn, he ControllerDirection);//初始化一个新的PID类	
