...
{ 
    ...
    __HAL_LINKDMA(&DAC1_Handler,DMA_Handle2,UART1TxDMA_Handler);    //将DMA与USART1联系起来(发送DMA)
    ...
    UART1TxDMA_Handler.Init.PeriphDataAlignment=DMA_PDATAALIGN_HALFWORD;    //外设数据长度:8位
    UART1TxDMA_Handler.Init.MemDataAlignment=DMA_MDATAALIGN_HALFWORD;       //存储器数据长度:8位
